...
void VRHelper::Init()
{
	...
	vr_weapontilt = gEngfuncs.pfnRegisterVariable("vr_weapontilt", "0", FCVAR_ARCHIVE);
	...
	g_vrInput.vr_control_deadzone = gEngfuncs.pfnRegisterVariable("vr_control_deadzone", "0.1", FCVAR_ARCHIVE);
